...
export default function RestaurantDashboard() {
  ...
  const {
    ...
    error: ordersError,
  } = useGetRestaurantOrdersQuery({ limit: 5 });
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
        ...
        <View style={styles.heroCard}>
          <View style={styles.heroHeader}>
            ...
            <TouchableOpacity style={styles.openToggle} onPress={handleToggleOpen}>
          ...
          {recentOrders.length === 0 ? (
            ...
            recentOrders.map((order) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({ pathname: '/(restaurant)/pedidos', params: { orderId: order.id } })
                }
              >
