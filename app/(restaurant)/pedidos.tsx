...
export default function RestaurantOrdersScreen() {
  ...
  const getActionLabel = useCallback((status: RestaurantOrderStatus): string => {
    switch (status) {
      ...
      case "ready": return "Enviar Entrega";
      default: return "";
    }
  }, []);
  ...
  const renderOrder = useCallback(({ item }: { item: RestaurantOrder }) => {
  ...
  }, [getNextStatus, getActionLabel, getStatusColor, getStatusLabel, formatTime, formatCurrency, handleUpdateStatus, styles]);
