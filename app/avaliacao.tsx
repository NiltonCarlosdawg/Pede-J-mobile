    ...
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.successContainer}>
          ...
          <Button
            title={isImmediate ? 'Concluir' : 'Voltar aos pedidos'}
            onPress={() => router.replace(isImmediate ? '/(tabs)' : '/(tabs)/pedidos')}
          />
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <Header
        ...
        showBack
        onBackPress={() => (isImmediate ? router.replace('/(tabs)') : router.back())}
      />
