      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileImageContainer}>
            ...
            />
            <TouchableOpacity
              style={[styles.editButton, isSmallScreen && { width: 28, height: 28 }]}
            >
          ...
          <Text style={[styles.profileEmail, isSmallScreen && { fontSize: 12 }]}>
            {profileEmail}
          </Text>
        ...
        <View style={styles.settingsCard}>
          <Text style={[styles.sectionTitle, isSmallScreen && { fontSize: 11 }]}>
          ...
          <TouchableOpacity style={styles.settingItem}>
            ...
            <Text style={[styles.settingText, isSmallScreen && { fontSize: 14 }]}>
              Notificações
            </Text>
            <MaterialCommunityIcons
              name="chevron-right"
        ...
        <View style={[styles.accountSection, isSmallScreen && { flexDirection: 'column' }]}>
          <View style={styles.infoCard}>
            <View style={styles.infoHeader}>
              ...
              <Text style={[styles.infoTitle, isSmallScreen && { fontSize: 14 }]}>
            ...
            <View style={styles.infoRow}>
              <Text style={[styles.infoLabel, isSmallScreen && { fontSize: 11 }]}>
                Nome Completo
              </Text>
              <Text style={[styles.infoValue, isSmallScreen && { fontSize: 13 }]}>
                {profileName}
              </Text>
            </View>
            <View style={styles.infoRow}>
        ...
        >
          ...
          <View style={styles.orderContent}>
            <Text style={[styles.orderTitle, isSmallScreen && { fontSize: 15 }]}>
              Histórico de Pedidos
            </Text>
            <Text style={[styles.orderSubtitle, isSmallScreen && { fontSize: 12 }]}>
              Ver pedidos anteriores e pedir novamente
            </Text>
          </View>
          <MaterialCommunityIcons
            name="arrow-right"
        ...
        <View style={styles.supportSection}>
          ...
          <TouchableOpacity style={styles.supportItem}>
            ...
            <Text style={[styles.supportText, isSmallScreen && { fontSize: 14 }]}>
              Central de Ajuda
            </Text>
          </TouchableOpacity>
