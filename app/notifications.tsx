    ...
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>Você receberá notificações sobre seus pedidos aqui.</Text>
        </View>
      </SafeAreaView>
    );
  }
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
        <View style={styles.headerActions}>
          ...
          {unreadCount > 0 && (
            ...
            >
              <MaterialCommunityIcons name="check-all" size={18} color={colors.primary[500]} />
