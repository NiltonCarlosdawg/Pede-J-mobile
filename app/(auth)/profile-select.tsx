      ...
      <View style={styles.content}>
        ...
        <View style={styles.header}>
          <View style={styles.logoContainer}>
            <MaterialCommunityIcons name="food-variant" size={48} color={colors.primary[500]} />
          </View>
          <Text style={styles.title}>Bem-vindo ao PedeJá</Text>
          <Text style={styles.subtitle}>Escolha como deseja usar o aplicativo</Text>
        </View>
        ...
        <View style={styles.cardsContainer}>
            ...
            >
              ...
              >
                <MaterialCommunityIcons
                  ...
                  size={32}
                  color={selectedRole === 'client' ? colors.white : colors.primary[500]}
                />
              </View>
          ...
          <Pressable
            ...
            style={[styles.card, selectedRole === 'delivery' && styles.cardSelected]}
          >
            <Animated.View
              style={[
                styles.cardContent,
            ...
            >
              ...
              >
                <MaterialCommunityIcons
                  name="motorbike"
                  size={32}
                  color={selectedRole === 'delivery' ? colors.white : colors.secondary[500]}
                />
              </View>
