    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.content}>
        ...
        >
          ...
          >
            <MaterialCommunityIcons name="check-bold" size={64} color={colors.white} />
          </Animated.View>
        </Animated.View>
      ...
      {/* Buttons */}
      <Animated.View style={[styles.footer, { transform: [{ translateY: buttonTranslate }] }]}>
        <Button title="Acompanhar Pedido" onPress={() => router.replace('/(tabs)/pedidos')} />
