...
export default function DeliveryDashboard() {
  ...
  const error =
    isErrorAvailable || isErrorEarnings ? 'Erro ao carregar dados. Puxe para atualizar.' : null;
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.heroCard}>
          ...
          <Text style={styles.subtitle}>Acompanhe seus ganhos e aceite novas entregas.</Text>
        </View>
          ...
          <View style={styles.earningsGrid}>
            ...
            <View style={styles.earningMetric}>
              <Text style={styles.earningValue}>
                {formatCurrency(earnings?.mediaPorEntrega ?? 0)}
              </Text>
            ...
            recentDeliveries.map((job) => (
              ...
              >
                ...
                <View style={styles.jobContent}>
                  ...
                  <Text style={styles.jobMeta}>{formatCurrency(job.deliveryFee)}</Text>
                </View>
              ...
              >
                <View style={styles.historyIcon}>
                  <MaterialCommunityIcons
                    name={
                      delivery.status === 'delivered' ? 'check-circle-outline' : 'clock-outline'
                    }
                    size={20}
                    color={
                      delivery.status === 'delivered' ? colors.primary[500] : colors.secondary[500]
                    }
                  />
                </View>
