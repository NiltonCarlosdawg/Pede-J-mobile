        ...
        {error ? (
          ...
          <>
            <View style={styles.totalCard}>
              ...
              <Text style={styles.totalValue}>Kz {(earnings.totalGanho || 0).toLocaleString()}</Text>
              <View style={styles.totalRow}>
                ...
                <View style={styles.totalItem}>
                  <Text style={styles.totalItemValue}>Kz {(earnings.mediaPorEntrega || 0).toLocaleString()}</Text>
            ...
            <View style={styles.statsGrid}>
              <View style={styles.statCard}>
                ...
                <Text style={styles.statValue}>Kz {(earnings.mediaPorEntrega || 0).toLocaleString()}</Text>
