...
export default function DeliveryChatScreen() {
  ...
  async function handleSend(text: string = inputText.trim()) {
    ...
    setSending(true);
    try {
      await sendMessage({ orderId, texto: text, tipo: 'texto' }).unwrap();
      setInputText('');
  ...
  function renderMessage({ item }: { item: ChatMessage }) {
    ...
    return (
      ...
      >
        {!isDelivery && !isSystem && <Text style={styles.senderName}>Cliente</Text>}
        <Text
          style={[
            styles.messageText,
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                ...
                />
                <Text style={styles.emptyText}>Inicie uma conversa com o cliente</Text>
              </View>
            }
          />
        )}
