...
import { selectPaymentMethods, setDefaultPaymentMethod } from '../src/store/paymentMethodsSlice';
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.container}>
        <Header title="Métodos de Pagamento" showBack onBackPress={() => router.back()} />

        <View style={styles.infoCard}>
          <MaterialCommunityIcons name="information" size={20} color={colors.primary[500]} />
          <Text style={styles.infoText}>
            Escolha sua carteira digital preferida. Todas as opções são seguras e disponíveis em
            Angola.
          </Text>
        </View>
