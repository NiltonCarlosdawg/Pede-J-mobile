...
export function ProductCard({
  ...
  if (isFeatured) {
    return (
      <TouchableOpacity
        style={[styles.featuredCard, !isAvailable && styles.disabled]}
        onPress={onPress}
      >
        <View style={styles.featuredImageContainer}>
          <Image
            source={{
              uri: image || 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400',
            }}
    ...
    <TouchableOpacity style={[styles.card, !isAvailable && styles.disabled]} onPress={onPress}>
      <View style={styles.content}>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={{
              uri: image || 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=200',
            }}
            style={styles.image}
          />
          {isAvailable && (
