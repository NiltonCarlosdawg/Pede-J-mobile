...
export function TrackingMap({
  ...
  const driverLatProgress =
    latRange !== 0 ? (driverLocation.latitude - restaurantLocation.latitude) / latRange : 0;
  const driverLonProgress =
    lonRange !== 0 ? (driverLocation.longitude - restaurantLocation.longitude) / lonRange : 0;
